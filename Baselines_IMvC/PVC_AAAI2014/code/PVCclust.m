function [Ux Uy P2 P1 P3 objValue Acc nmi Purity ARI] = PVCclust(X2,Y2,X1,Y3,numClust,truth,option)
...
if (1)
   ...
   fprintf('acc: %f(%f)\tnmi: %f(%f) Pur:%f\n', Acc*100, std(Acci), nmi*100, std(nmii),Pur*100);
